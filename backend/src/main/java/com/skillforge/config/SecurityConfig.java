...
import com.skillforge.security.ratelimit.AuthRateLimitingFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // Without this, Spring Security's default entry point returns a bare 403 for
                // missing/invalid tokens instead of 401, which breaks the frontend's
                // "401 -> clear token and redirect to /login" interceptor logic.
                .exceptionHandling(ex -> ex.authenticationEntryPoint(new HttpStatusEntryPoint(HttpStatus.UNAUTHORIZED)))
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/register", "/auth/login").permitAll()
                        // Extension points for future controllers:
